...
/**
 * Journal Note, Copyright (C) 2018 www.fouomene.com.
 *
 * Created by FOUOMENE on 06/2018.
 * EmailAuthor:  fouomenedaniel@gmail.com .
 *
 *
 * Manages "Authentication" to Journal Doodle's backend service.  The SyncAdapter framework
 ...
 */
public class DoodlesArchiveAuthenticator extends AbstractAccountAuthenticator {

    public DoodlesArchiveAuthenticator(Context context) {
        super(context);
    }
